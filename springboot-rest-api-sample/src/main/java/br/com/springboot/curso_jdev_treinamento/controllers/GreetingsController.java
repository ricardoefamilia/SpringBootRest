...
public class GreetingsController {
    ...
    @GetMapping(value = "buscauserporid")
    @ResponseBody /* descrição da resposta */
    ...
    public ResponseEntity<?> atualizar(@RequestBody Usuario usuario){
    	...
    	Usuario user = usuarioRepository.saveAndFlush(usuario); /* salva e retorna os dados */
    	return new ResponseEntity<Usuario>(user, HttpStatus.OK);
    }
    
    @GetMapping(value = "buscarUserPorNome")
    @ResponseBody  /* descrição da resposta */
    public ResponseEntity<List<Usuario>> buscarUserPorNome(@RequestParam(name = "nome") String nome){
    	List<Usuario> usuarios = usuarioRepository.buscarUserPorNome(nome.trim().toUpperCase());
